    ...
    <div className="service">
      ...
      <div className="crousel">
        <Slider {...settings}>
          ...
          <div className='cdiv1'>
          <Link to={props.to}><img src={props.img7} alt="img6" /></Link>
            <p>{props.h7}</p>
          </div>
          <div className='cdiv1'>
          <Link to={props.to}><img src={props.img8} alt="img6" /></Link>
            <p>{props.h8}</p>
          </div>
          <div className='cdiv1'>
          <Link to={props.to}><img src={props.img9} alt="img6" /></Link>
            <p>{props.h9}</p>
          </div>
        </Slider>
      </div>
