    ...
    <div className="service">
      ...
      <div className="crousel">
        <Slider {...settings}>
          ...
          <div className='cdiv1'>
          <Link to={props.to}><img src={props.img6} alt="img5" /></Link>
            <p>{props.h6}</p>
          </div>
          <div className='cdiv1'>
          <Link to={props.to}><img src={props.img7} alt="img5" /></Link>
            <p>{props.h7}</p>
          </div>
        </Slider>
      </div>
...
export default InteriorCrousel